...
$ asadmin start-domain domain1; asadmin start-database; asadmin deploy DirectoryManager/directoryManager.api/target/directoryManager.api-1.0-SNAPSHOT.jar;asadmin deploy AuctionManager/auctionManager.bean/target/auctionManager.bean-1.0-SNAPSHOT.jar;
